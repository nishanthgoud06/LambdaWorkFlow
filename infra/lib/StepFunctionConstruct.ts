...
export class StepFunctionConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: StepFunctionConstructProps) {
    ...
    const addEntryTask = new sfnTasks.DynamoPutItem(
      this,
      'Add Entry to DynamoDB',
      {
        table,
    ...
    const updateACompletedTask = new sfnTasks.DynamoUpdateItem(
      this,
      'Update A to Completed',
      {
        table,
        key: {
          ExecutionId: sfnTasks.DynamoAttributeValue.fromString(
        ...
        updateExpression:
          'SET #status = :status, #name = :name, #timestamp = :timestamp',
        ...
        resultPath: '$.UpdateACompletedResult',
        outputPath: '$',
      }
    );
    ...
    const updateBCompletedTask = new sfnTasks.DynamoUpdateItem(
      this,
      'Update B to Completed',
      {
        table,
        key: {
          ExecutionId: sfnTasks.DynamoAttributeValue.fromString(
    ...
    const updateFailedTask = new sfnTasks.DynamoUpdateItem(
      this,
      'Update to Failed',
      {
        table,
